        ...
        <div class="course-info">
          ...
          <div class="wrap-right">
            ...
            <div class="sale-time" v-if="course.discount_name">
              ...
              <p class="expire">
                距离结束：仅剩 {{course.active_time/60/60/24 | format_time}}天
              {{course.active_time/60/60 % 24 | format_time}}小时
              {{course.active_time/60 % 60 | format_time}}分
              <span class="second">{{course.active_time % 60|format_time}}</span> 秒</p>
            </div>
...
export default {
    ...
    data(){
      return {
        ...
        playerOptions: {
          ...
          sources: [{ // 播放资源和资源格式
            type: "video/mp4",
            src: "https://video.pearvideo.com/mp4/adshort/20180606/cont-1361037-12207919_adpkg-ad_hd.mp4" //你的视频地址（必填）
          }],
    ...
    methods: {
      ...
      get_course_id(){
          let course_id = this.$route.params.id; //获取浏览器地址栏传过来的参数
