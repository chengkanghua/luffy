    ...
    <div class="cart-info">
      ...
      <div class="discount">
        ...
        <div class="credit-box">
            ...
            <p class="discount-num2" v-else><span>总积分：{{user_credit}}，抵扣 <el-input-number @change="handleChange"  v-model="credit" :min="0" :max="max_credit()" label="请填写积分"></el-input-number>，本次花费以后，剩余{{parseInt(user_credit-credit)}}积分</span>
            </p>
          </div>
        ...
        this.coupon_list.forEach((value,key)=>{
          if (value.id === this.coupon){
            ...
            if (now_timestamp > start_timestamp && now_timestamp <= end_timestamp){
              ...
              let d = parseFloat(cal_func.substr(1));
              if (cal_func[0] === "*"){
