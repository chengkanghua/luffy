...
class Course(BaseModel):
    ...
    # 课程原价
    price = models.DecimalField(max_digits=6, decimal_places=2, verbose_name="课程原价", default=0,help_text='如果价格为0，那么该课程没有永久有效的选项')
    ...
    def active_list(self):
        active_lists = self.activeprices.filter(is_show=True, is_deleted=False, active__start_time__lte=datetime.now(),
        ...
        if len(active_lists) > 0:
            ...
            if price > condition:
                ...
                if sale == '':
                    ...
                    price = price - max(con_price_list)
